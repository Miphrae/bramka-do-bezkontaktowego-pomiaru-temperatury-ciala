...
if __name__ == "__main__":
    ...
    flag_work = True
    while flag_work:
        send_file("team15@192.168.0.91:~/Desktop/bramka_pomiarowa/dane.csv", "C:\\Users\\anhqu\\Desktop\\University\\semestr_4\\PROJ2")
        ...
        # for i in range(5):
            with open(f"plik_{number_of_files}.csv", "w") as file:
